...
const NewsDetailsPage = async ({ params }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto my-12">
      <h1 className="text-2xl font-semibold mb-6 text-gray-800">Dragon News</h1>

      <div className="card bg-base-100 border border-base-100 rounded-md p-7 shadow-sm">
        {/* 1. Main News Image */}
        <div className="relative w-full h-112.5 mb-8 rounded-md overflow-hidden bg-gray-100">
          <Image
        ...
        {/* 4. 'All news in this category' Button */}
